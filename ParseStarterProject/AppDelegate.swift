...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //Uncomment and fill in with your Parse credentials:
         Parse.setApplicationId("VlGitHhSXRDc4J8IYaEtMr5ujKuIiq6jsi8pajyH", clientKey: "Wo2QAySx7dNSTt7NMCI9ZLiE5qWQDoJziz0GdSST")
        //
        ...
        let loginVC = createTabBarVC()//StartViewController(nibName:"StartViewController", bundle:nil);
    ...
    func createTabBarVC() -> UITabBarController {
        ...
        let newOrderVC = NewOrdersViewController(nibName:"NewOrdersViewController", bundle:nil)
